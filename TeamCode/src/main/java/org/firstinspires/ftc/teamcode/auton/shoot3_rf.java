...
@Autonomous(name = "*shoot3_rf", group = "Autonomous")
public class shoot3_rf extends OpMode {
    ...
    private final Pose startPose = new Pose(84.000, 8.000, Math.toRadians(90));

    public void buildPaths() {
        path1 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(84.000, 8.000), new Pose(84.000, 20.000)))
                .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(90))
                .build();
        path2 = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(84.000, 20.000), new Pose(84.000, 100.000)))
                .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(33))
                .build();
    }

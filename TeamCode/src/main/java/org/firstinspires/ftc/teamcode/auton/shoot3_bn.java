...
@Autonomous(name = "shoot3_bn", group = "Autonomous")
public class shoot3_bn extends OpMode {
    ...
    private final Pose startPose = new Pose(22.000, 125.000, Math.toRadians(143));

    public void buildPaths() {
        scorePath = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(22.000, 125.000), new Pose(52.000, 110.000)))

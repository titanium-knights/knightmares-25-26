...
//
//
//@Autonomous(name = "test_upStopup", group = "Examples")
//public class test_upStopup extends OpMode{
...
//    private final Pose TEST_moreUP= new Pose(92, 72, Math.toRadians(0));
//    private final Pose TEST_DOWN = new Pose(62, 72, Math.toRadians(0));
//
//
//    private PathChain UP, DOWN, LEFT, RIGHT, moreUP;
//
//    public void buildPaths() {
//
//        moreUP = follower.pathBuilder()
//                .addPath(new BezierLine(new Point(TEST_UP), new Point(TEST_moreUP)))
//                .setLinearHeadingInterpolation(START.getHeading(), TEST_moreUP.getHeading())
//                .build();
//

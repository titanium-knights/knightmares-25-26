...
//
//
//@Autonomous(name = "nearHuman_park_pedro", group = "Examples")
//public class nearHuman_park_pedro extends OpMode{
...
//
//        straightPark_PATH = new Path(new BezierLine(new Point(startP_HUMAN), new Point(straightToParkP_HUMAN)));
//        straightPark_PATH.setLinearHeadingInterpolation(startP_HUMAN.getHeading(), straightToParkP_HUMAN.getHeading());
//
//    }

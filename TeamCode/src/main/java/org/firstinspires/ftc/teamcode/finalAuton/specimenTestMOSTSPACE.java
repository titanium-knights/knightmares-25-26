...
@Autonomous(name = "specimenTestMOSTSPACE", group = "Examples")
public class specimenTestMOSTSPACE extends OpMode{
    ...
    private final Pose specimenP_HUMAN = new Pose(12, 68, Math.toRadians(180));
    private final Pose spaceF = new Pose(9, 68, Math.toRadians(180));

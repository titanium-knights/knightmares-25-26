...
//
//
//@Autonomous(name = "nearBasket_pushBot_NoSpecimen_pedro", group = "Examples")
//public class nearBasket_pushBot_NoSpecimen_pedro extends OpMode{
...
//                break;
//            case 1:
//                if(follower.getPose().getX() > (startControllP_BASKET.getX() - 1) && follower.getPose().getY() > (startControllP_BASKET.getY() - 1)) {

...
@Autonomous(name = "NB_lessSpace", group = "Examples")
public class NB_lessSpace extends OpMode{
    ...
    private final Pose specimenP_BASKET = new Pose(33, 80, Math.toRadians(180));
    private final Pose specimenSPACE_BASKET = new Pose(23, 80, Math.toRadians(180));
